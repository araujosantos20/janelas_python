...
# selecionado o banco de dados loja_db
db = client.loja_db

# Estamos obtendo os dados que estão cadastrado na
...
# leitura de todas linha com o for e exibimos
# na tela
...
# usuario_id = db["usuario"].insert_one({"nomeusuario": "Jaime", "senha": "123", "nivel": "usuario"}).inserted_id
# print(usuario_id)
